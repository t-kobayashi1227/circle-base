  ...
  public: {
    Tables: {
      ...
      circle_favorites: {
        ...
        Relationships: [
          {
            foreignKeyName: "circle_favorites_circle_id_fkey"
            columns: ["circle_id"]
            isOneToOne: false
            referencedRelation: "circles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "circle_favorites_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      circle_update_images: {
        Row: {
          circle_update_id: string
          id: string
          sort_order: number
          storage_path: string
        }
        ...
        Relationships: [
          {
            foreignKeyName: "circle_update_images_circle_update_id_fkey"
            columns: ["circle_update_id"]
            isOneToOne: false
            referencedRelation: "circle_updates"
            referencedColumns: ["id"]
          },
        ]
      }
      circle_updates: {
        ...
        Relationships: [
          {
            foreignKeyName: "circle_updates_circle_id_fkey"
            columns: ["circle_id"]
            isOneToOne: false
            referencedRelation: "circles"
            referencedColumns: ["id"]
      ...
      circles: {
        ...
        Relationships: [
          {
            foreignKeyName: "circles_area_id_fkey"
            columns: ["area_id"]
            isOneToOne: false
